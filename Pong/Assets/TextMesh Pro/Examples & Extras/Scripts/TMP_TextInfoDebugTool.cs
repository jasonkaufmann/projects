            ...
            for (var i = 0; i < textInfo.lineCount; i++) {
                ...
                var isLineVisible = lineInfo.characterCount == 1 &&
                                    (textInfo.characterInfo[lineInfo.firstCharacterIndex].character == 10 ||
                                     textInfo.characterInfo[lineInfo.firstCharacterIndex].character == 11) ||
                ...
                Vector3 topOrigin =
                    m_Transform.TransformPoint(new Vector3(textInfo.characterInfo[lineInfo.firstCharacterIndex].origin,
                        ascender, 0));
                Vector3 bottomAdvance =
                    m_Transform.TransformPoint(new Vector3(textInfo.characterInfo[lineInfo.lastCharacterIndex].xAdvance,
                        descender, 0));
                Vector3 topAdvance =
                    m_Transform.TransformPoint(new Vector3(textInfo.characterInfo[lineInfo.lastCharacterIndex].xAdvance,
                        ascender, 0));
