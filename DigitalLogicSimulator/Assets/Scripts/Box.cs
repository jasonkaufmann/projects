...
public class Box : MonoBehaviour
{
    ...
    {
        Vector2 anchorPoint;
        var averagePos = GetAverageAnchorPointPosition();
        ...
        var p1 = Lerp(start, anchorPoint, t);
        var p2 = Lerp(anchorPoint, end, t);
    ...
    {
        var anchorPointSum = Vector2.zero;
        foreach (var point in _drawPoints) anchorPointSum += point;
