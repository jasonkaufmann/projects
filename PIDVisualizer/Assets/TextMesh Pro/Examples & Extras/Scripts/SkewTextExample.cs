...
namespace TMPro.Examples {
    public class SkewTextExample : MonoBehaviour {
        public AnimationCurve VertexCurve =
            new(new Keyframe(0, 0), new Keyframe(0.25f, 2.0f), new Keyframe(0.5f, 0), new Keyframe(0.75f, 2.0f),
                new Keyframe(1, 0f));
